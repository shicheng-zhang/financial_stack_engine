...
class PaperLedger:
    ...
    def _init_tables(self):
        self.con.execute("""
            ...
            CREATE TABLE IF NOT EXISTS trades (id INTEGER PRIMARY KEY, ts TIMESTAMP, symbol VARCHAR, side VARCHAR, qty DOUBLE, price DOUBLE, slippage_bps DOUBLE, commission DOUBLE);
        """)
